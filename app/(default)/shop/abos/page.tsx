...
export const metadata = {
  title: "Abos & Preise - Simple",
  description: "Pricing, das mit deinem Team und deinem System mitwächst.",
};
  ...
  return (
    <div className="bg-white py-24 sm:py-32">
      ...
      <div className="relative pt-16 sm:pt-24">
        <div className="absolute inset-x-0 top-48 bottom-0 bg-[radial-gradient(circle_at_center_center,var(--color-hero-gradient-start),var(--color-hero-gradient-mid),var(--color-hero-gradient-end)_70%)] lg:bg-[radial-gradient(circle_at_center_150%,var(--color-hero-gradient-start),var(--color-hero-gradient-mid),var(--color-hero-gradient-end)_70%)]" />
